    ...
    <div className="min-h-screen bg-[#0F2A47] flex items-center justify-center p-4" dir={isAr ? 'rtl' : 'ltr'}>
      ...
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          <div className="w-20 h-20 bg-[#C8A951]/20 border-2 border-[#C8A951]/40 rounded-3xl flex items-center justify-center mx-auto mb-4">
            <Shield size={36} className="text-[#C8A951]" />
          </div>
        ...
        <div className="bg-white rounded-3xl p-6 shadow-2xl">
          <h1 className="font-black text-[#0F2A47] text-xl mb-1">{isAr ? 'تسجيل الدخول' : 'Sign In'}</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full border-2 border-[#E8E4DC] rounded-xl py-3 text-sm outline-none focus:border-[#0F2A47] transition-colors ${isAr ? 'pr-9 pl-3' : 'pl-9 pr-3'}`}
                  required
                  dir="ltr"
                />
              </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="••••••••"
                  className={`w-full border-2 border-[#E8E4DC] rounded-xl py-3 text-sm outline-none focus:border-[#0F2A47] transition-colors ${isAr ? 'pr-9 pl-10' : 'pl-9 pr-10'}`}
                  required
                  dir="ltr"
                />
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3.5 bg-[#0F2A47] text-white font-black rounded-xl text-sm hover:bg-[#1a3a5c] transition-colors disabled:opacity-60 flex items-center justify-center gap-2"
            >
              {loading ? (
          ...
          {/* Hint */}
          <div className="mt-4 bg-[#FBF8F2] rounded-xl p-3 text-center">
